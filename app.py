...
# =============================================================================
st.set_page_config(
    page_title="Operations Optimization Tool", 
    layout="wide",
    initial_sidebar_state="expanded"
)

# App Title
st.title("🧮 Operations & Logistics Optimization Tool")

# Project Overview & Syllabus Context tucked into a clickable, expandable drawer
with st.expander("📖 View Project Overview & Syllabus Context"):
    st.markdown(
        """
        ...
        **Strategic Business Leader (SBL)** syllabi into dynamic, data-driven optimization tools using 
        ...
        and deployed seamlessly via a unified Streamlit framework, this framework bridges the gap between accounting 
